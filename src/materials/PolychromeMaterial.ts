...
// ↓↓↓ Ниже вставляй весь код из shaders/polychrome.fs, но перед этим 
// добавь строку uniform vec2 uMouse; и uniform float time; в начало.

uniform vec2 uMouse;
uniform float time;
// --- Здесь начнётся содержимое polychrome.fs (копируй его целиком) ---
...
uniform MY_HIGHP_OR_MEDIUMP number dissolve;
...
#endif
// --- Конец содержимого из shaders/polychrome.fs ---
`;
